...
const Card = ({
  ...
  if (type === "category") {
   ...
   return (
    <div className="bg-[#f5f5f5] rounded-xl overflow-hidden shadow hover:shadow-xl transition-all duration-300 group">
        ...
        />
         ...
         <div className="absolute top-3 right-3 flex flex-col gap-3   group-hover:opacity-100 transition-opacity duration-300">
          <div className="bg-white p-2 rounded-full shadow-lg hover:bg-red-50 transition">
            <FavoriteBorder className="text-gray-700 hover:text-red-600 cursor-pointer" />
          </div>
